module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		options: {
			...
			publish: 'public/assets/minified',
			...
			css: {
				...
				files: ['assets/css/bootstrap.css','assets/css/bootstrap-select.css'],							// CSS files in order you'd like them concatenated and minified
				concat: '<%= options.css.base %>/concat.css',	// Name of the concatenated CSS file
				min: '<%= options.publish %>/application.min.css'		// Name of the minified CSS file
			},

			// JavaScript settings
			js: {
				base: 'assets/js',							// Base path to you JS folder
				files: ['assets/js/plugins.js','assets/js/script.js'],							// JavaScript files in order you'd like them concatenated and minified
				concat: '<%= options.js.base %>/concat.js',		// Name of the concatenated JavaScript file
				min: '<%= options.publish %>/application.min.js'		// Name of the minified JavaScript file
			},
			...
			sass: {
				...
				file: 'assets/sass/bootstrap.sass',							// SASS file (ideally, one file which contains imports)
